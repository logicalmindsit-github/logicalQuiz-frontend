  ...
  const fetchQuestion = async () => {
    try {
      ...
      const response = await axios.get(
        ` 
        https://logical-quiz-backend-43lpx.ondigitalocean.app/exam/getExamQuestions?std=6&examinationName=test.1`,
        {
          headers: {
      ...
      >
        <div style={{ display: "flex", justifyContent: "center" }}>
          <div style={{ width: "85%", textAlign: "center", padding: "20px" }}>
            <h1
              style={{ fontSize: "1.5rem", color: "black", marginRight: "12%" }}
            >
              Questions...
            </h1>
            <br />
        ...
        <div style={{ position: "relative", marginLeft: "780px" }}>
