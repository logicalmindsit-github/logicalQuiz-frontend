...
export default function ExamFour() {
  ...
  const fetchQuestion = async () => {
    try {
      ...
      const response = await axios.get(
        ` 
        https://logical-quiz-backend-43lpx.ondigitalocean.app/exam/getExamQuestions?std=6&examinationName=test.4`,
        {
          headers: {
